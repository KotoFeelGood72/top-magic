...
// Видео на странице Case
const main_case_video = new Plyr(document.querySelector('.video_block'), {
	invertTime: false,
	controls: ['play-large',
	'play', 'progress', 'current-time', 'duration', 'mute', 'volume', 'captions','pip','airplay', 'fullscreen' ],
	muted: false,
	iconUrl: spriteUrl,
	hideControls: true,
    playerVars: { 'rel':0}
